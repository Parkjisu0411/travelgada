			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
	            ...
	            <div class="nav-item dropdown">
					...
					<sec:authorize access="isAnonymous()">
						<a class="nav-link dropdown-toggle nav-dropdown-toggle-user" href="/member/login" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">
							<img src="/resources/img/profile/default_profile_img.jpg" class="nav-profile-img">
						</a>
					</sec:authorize>
				</div>
			</div>
