...
=======
  <nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="/planner" id="navbarDropdown"
              role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 플래너 </a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="/planner">일정</a> <a class="dropdown-item" href="#">준비물</a> <a
          ...
          <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="/board/qna">Q&amp;A</a> <a class="dropdown-item"
                href="/board/review">리뷰</a> <a class="dropdown-item" href="/board/accompany">동행</a>
            </div>
          </li>
          <li class="nav-item"><a class="nav-link" href="#">쇼핑</a></li>
        </ul>
        ...
        <div class="nav-item dropdown user">
          <sec:authorize access="isAuthenticated()">
            <a class="nav-link dropdown-toggle user" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
              aria-haspopup="true" aria-expanded="false"><img src="<sec:authentication property=" principal.profile" />"
              class="nav-profile-img"
              onerror="this.src='/resources/img/profile/default_profile_img.jpg'"></a>
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="/member/mypage">마이페이지</a>
              <div class="dropdown-divider"></div>
              <form id="logout" action="/member/logout" method="POST">
                <input name="${_csrf.parameterName}" type="hidden" value="${_csrf.token}" /> <a class="dropdown-item"
                  href="#" onclick="document.getElementById('logout').submit();">로그아웃</a>
              </form>
            </div>
          </sec:authorize>
          <sec:authorize access="isAnonymous()">
            <a class="nav-link dropdown-toggle user" href="/member/login" id="navbarDropdown" role="button"
              aria-haspopup="true" aria-expanded="false"><img src="/resources/img/profile/default_profile_img.jpg"
                class="nav-profile-img"></a>
          </sec:authorize>
        </div>
      </div>
...
>>>>>>> b195e2629fa1db07ae8220e8ca4d40b8c5cf06c9
</body>
