			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle nav-dropdown-toggle" href="/planner" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 플래너 </a>
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle nav-dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 커뮤니티 </a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item nav-dropdown-item" href="/board/2">Q&amp;A</a>
							<a class="dropdown-item nav-dropdown-item" href="/board/1">리뷰</a> <a class="dropdown-item nav-dropdown-item" href="/board/3">동행</a>
				...
				<div class="nav-item dropdown">
					<sec:authorize access="isAuthenticated()">
						<a class="nav-link dropdown-toggle nav-dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<img src="/resources/img/profile/<sec:authentication property="principal.profile"/>" class="nav-profile-img" onerror="this.src='/resources/img/profile/default_profile_img.jpg'">
						</a>
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<form id="logout" action="/member/logout" method="POST">
								<input name="${_csrf.parameterName}" type="hidden" value="${_csrf.token}" /> <a class="dropdown-item nav-dropdown-item" href="#" onclick="document.getElementById('logout').submit();">로그아웃</a>
							</form>
						</div>
					</sec:authorize>
