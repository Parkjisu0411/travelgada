...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIxMDMyMjE5MTEwOTExMDk1MDE=";//승인키
...
<body onload="init();">
	<form id="form" name="form" method="post">
		...
		<input type="hidden" id="confmKey" name="confmKey" value="devU01TX0FVVEgyMDIxMDMyMjE5MTEwOTExMDk1MDE="/>
		<input type="hidden" id="returnUrl" name="returnUrl" value="/member/shipping/enroll"/>
		<input type="hidden" id="resultType" name="resultType" value="4"/> // resultType항목 추가(2016.10.06)
	</form>
</body>
</html>
