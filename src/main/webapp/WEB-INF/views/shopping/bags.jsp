...
<body>
	...
	<div class="container">
		...
		<!-- headline -->
		<h2 class="gada-headline">BAGS</h2>
		
		<div class="gada-btn-group">
			<a href="/shopping?product_type_id=3&sorter=salePriceAsc" class="btn gada-btn">낮은가격순</a>
			<a href="/shopping?product_type_id=3&sorter=salePriceDesc" class="btn gada-btn">높은가격순</a>
			<a href="/shopping?product_type_id=3&sorter=saleCountDesc" class="btn gada-btn">판매량순</a>
			<a href="/shopping?product_type_id=3&sorter=latestAsc" class="btn gada-btn">최신순</a>
		</div>
		<hr />
