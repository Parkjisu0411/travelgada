    ...
    <div class="row">
      <div class="col-md-8 content">
        ...
        <div class="shipping-loc-area">
          ...
          <button type="button" class="btn gada-btn-white" data-toggle="modal" data-target="#exampleModalCenter">주소록</button>
          ...
          <input type="text" id="tel" class="form-control input-information" maxlength="11" placeholder="연락처" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" />
          <p>-없이 입력해 주세요.</p>
        </div>
        <hr>
        <h2 class="information-headline">포인트 사용</h2>
        <br>
        <input type="number" id="point" class="form-control input-information" onchange='printPoint()' min="0" value="0" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" style="display: inline; width: 420px !important;" />
      ...
      <div class="col-md-4 widget">
        ...
        <span class="total-price">₩<c:out value="${totalPrice}" /></span><br>
