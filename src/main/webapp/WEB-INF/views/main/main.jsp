  ...
  <%@ include file="/WEB-INF/views/includes/header_main.jsp" %>
    ...
    <div class="covid-19">
      <a href="https://www.0404.go.kr/dev/newest_view.mofa?id=ATC0000000008500&pagenum=1&mst_id=MST0000000000040&ctnm=&div_cd=&st=title&stext="
        target="_blank" class="covid-19-link"><i class="fas fa-info-circle"></i>발효중인 여행 주의보</a>
    </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 advice-content-area">
          ...
          <p class="advice-content">플래너를 이용하여 여행 계획을 세우고 챙겨야 할 준비물을 확인할 수 있습니다</p>
          <br>
          <span class="main-planner-add-button" onclick="location.href='http://localhost:8282/planner/schedule'">일정
            생성하기</span>
        </div>
      </div>
    </div>
    ...
    <div class="container recommendation-area">
              ...
              <div class="card-diary">
                ...
                <div class="diary-content">
                  <div class="diary-profile">
                    <img class="diary-profile-img" src="${contextPath}/resources/museum.jpg"> <a
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 advice-image-area">
          <img src="${pageContext.request.contextPath}/resources/img/main/product.jpg" class="advice-img">
        </div>
        <div class="col-md-4 advice-content-area">
          <h2 class="advice-title">가다에서 여행에 필요한 물품을 구매해 보세요</h2>
          <p class="advice-content">스토어를 이용하여 여행에 필요한 물품을 구매할 수 있습니다</p>
          <br>
          <span class="main-planner-add-button" onclick="location.href='http://localhost:8282/planner/schedule'">물품
            구매하기</span>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <h2 class="headline">가다가 추천하는 아이템</h2>
    </div>
    <div class="container recommendation-area">
      <div class="row flex-nowrap">
        <div class="col-md-3">
