...
<body>
  ...
  <div class="main-covid-19">
    <a href="https://www.0404.go.kr/dev/newest_view.mofa?id=ATC0000000008500&pagenum=1&mst_id=MST0000000000040&ctnm=&div_cd=&st=title&stext=" target="_blank" class="main-covid-19-link"><i class="fas fa-info-circle main-notice-icon"></i>발효중인 여행 주의보</a>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 advice-planner-outer-area">
        <div class="main-advice-planner-inner-area">
          ...
          <br>
          <span class="main-advice-button" onclick="location.href='http://localhost:8282/planner'">일정 생성하기</span>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-4 advice-content-area">
        <div class="main-advice-store-inner-area">
          ...
          <br>
          <span class="main-advice-button" onclick="location.href='/shopping?product_type_id=3'">물품 구매하기</span>
        </div>
      </div>
    </div>
  </div>
